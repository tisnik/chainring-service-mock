...
(deftest test-store-drawing-as-json-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/store-drawing-as-json definition exists."
...
(deftest test-store-drawing-as-edn-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/store-drawing-as-edn definition exists."
...
(deftest test-string->date-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/string->date definition exists."
...
(deftest test-write-binary-header-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-binary-header definition exists."
...
(deftest test-write-created-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-created definition exists."
...
(deftest test-write-counters-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-counters definition exists."
...
(deftest test-write-bounds-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-bounds definition exists."
...
(deftest test-write-scales-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-scales definition exists."
...
(deftest test-write-line-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-line definition exists."
...
(deftest test-write-circle-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-circle definition exists."
...
(deftest test-write-arc-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-arc definition exists."
...
(deftest test-write-text-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-text definition exists."
...
(deftest test-write-entity-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-entity definition exists."
...
(deftest test-write-entities-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-entities definition exists."
...
(deftest test-write-room-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-room definition exists."
...
(deftest test-write-rooms-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/write-rooms definition exists."
...
(deftest test-store-drawing-as-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/store-drawing-as-binary definition exists."
    (is (callable?
          'chainring-service.drawings-storage/store-drawing-as-binary))))
...
(deftest test-store-drawing-as-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/store-drawing-as definition exists."
...
(deftest test-read-binary-header-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-binary-header definition exists."
...
(deftest test-read-created-time-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-created-time definition exists."
...
(deftest test-read-counters-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-counters definition exists."
...
(deftest test-read-bounds-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-bounds definition exists."
...
(deftest test-read-scales-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-scales definition exists."
...
(deftest test-read-line-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-line-from-binary definition exists."
...
(deftest test-read-circle-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-circle-from-binary definition exists."
    (is (callable?
          'chainring-service.drawings-storage/read-circle-from-binary))))
...
(deftest test-read-arc-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-arc-from-binary definition exists."
...
(deftest test-read-text-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-text-from-binary definition exists."
...
(deftest test-read-entity-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-entity-from-binary definition exists."
    (is (callable?
          'chainring-service.drawings-storage/read-entity-from-binary))))
...
(deftest test-read-room-polygon-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-room-polygon definition exists."
...
(deftest test-read-room-from-binary-existence
  ...
  (testing
    "if the chainring-service.drawings-storage/read-room-from-binary definition exists."
