...
(deftest test-load-all-data-files-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/load-all-data-files definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/load-all-data-files))))
...
(deftest test-aoids-count-per-date-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/aoids-count-per-date definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/aoids-count-per-date))))
...
(deftest test-reload-mock-data-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/reload-mock-data definition exists."
...
(deftest test-get-real-date-from-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/get-real-date-from definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/get-real-date-from))))
...
(deftest test-read-all-dates-from-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-all-dates-from definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/read-all-dates-from))))
...
(deftest test-read-buildings-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-buildings definition exists."
...
(deftest test-read-building-info-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-building-info definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/read-building-info))))


(deftest test-read-floors-existence
  "Check that the chainring-service.mocked-sap-interface/read-floors definition exists."
  (testing
    "if the chainring-service.mocked-sap-interface/read-floors definition exists."
...
(deftest test-read-floor-info-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-floor-info definition exists."
...
(deftest test-read-rooms-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-rooms definition exists."
...
(deftest test-read-room-info-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-room-info definition exists."
...
(deftest test-read-room-attribute-types-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-room-attribute-types definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/read-room-attribute-types))))
...
(deftest test-read-rooms-attribute-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-rooms-attribute definition exists."
    (is (callable?
          'chainring-service.mocked-sap-interface/read-rooms-attribute))))
...
(deftest test-read-rooms-possible-attributes-existence
  ...
  (testing
    "if the chainring-service.mocked-sap-interface/read-rooms-possible-attributes definition exists."
    (is
      (callable?
        'chainring-service.mocked-sap-interface/read-rooms-possible-attributes))))
