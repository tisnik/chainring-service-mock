...
(deftest test-unknown-endpoint-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/unknown-endpoint-handler definition exists."
...
(deftest test-toplevel-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/toplevel-handler definition exists."
...
(deftest test-api-info-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/api-info-handler definition exists."
...
(deftest test-liveness-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/liveness-handler definition exists."
...
(deftest test-readiness-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/readiness-handler definition exists."
...
(deftest test-list-all-objects-existence
  ...
  (testing
    "if the chainring-service.rest-api/list-all-objects definition exists."
...
(deftest test-list-of-buildings-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/list-of-buildings-handler definition exists."
...
(deftest test-list-of-floors-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/list-of-floors-handler definition exists."
...
(deftest test-list-of-rooms-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/list-of-rooms-handler definition exists."
...
(deftest test-info-about-building-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/info-about-building-handler definition exists."
...
(deftest test-info-about-floor-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/info-about-floor-handler definition exists."
...
(deftest test-info-about-room-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/info-about-room-handler definition exists."
...
(deftest test-list-all-dates-from-existence
  ...
  (testing
    "if the chainring-service.rest-api/list-all-dates-from definition exists."
...
(deftest test-nearest-date-from-existence
  ...
  (testing
    "if the chainring-service.rest-api/nearest-date-from definition exists."
...
(deftest test-sap-reload-mock-data-existence
  ...
  (testing
    "if the chainring-service.rest-api/sap-reload-mock-data definition exists."
...
(deftest test-get-sap-selector-existence
  ...
  (testing
    "if the chainring-service.rest-api/get-sap-selector definition exists."
...
(deftest test-sap-href-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/sap-href-handler definition exists."
...
(deftest test-sap-debug-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/sap-debug-handler definition exists."
...
(deftest test-rooms-attribute-existence
  ...
  (testing
    "if the chainring-service.rest-api/rooms-attribute definition exists."
...
(deftest test-possible-attributes-existence
  ...
  (testing
    "if the chainring-service.rest-api/possible-attributes definition exists."
...
(deftest test-drawings-cache-info-handler-existence
  ...
  (testing
    "if the chainring-service.rest-api/drawings-cache-info-handler definition exists."
...
(deftest test-missing-parameter-existence
  ...
  (testing
    "if the chainring-service.rest-api/missing-parameter definition exists."
...
(deftest test-try-to-load-drawing-existence
  ...
  (testing
    "if the chainring-service.rest-api/try-to-load-drawing definition exists."
...
(deftest test-deserialize-drawing-existence
  ...
  (testing
    "if the chainring-service.rest-api/deserialize-drawing definition exists."
...
(deftest test-try-to-store-drawing-existence
  ...
  (testing
    "if the chainring-service.rest-api/try-to-store-drawing definition exists."
...
(deftest test-serialize-drawing-existence
  ...
  (testing
    "if the chainring-service.rest-api/serialize-drawing definition exists."
