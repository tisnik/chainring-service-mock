...
(deftest test-all-drawings-for-floor-existence
  ...
  (testing "if the chainring-service.server/all-drawings-for-floor definition exists."
...
(deftest test-prepare-drawing-info-existence
  ...
  (testing "if the chainring-service.server/prepare-drawing-info definition exists."
...
(deftest test-select-nearest-date-existence
  ...
  (testing "if the chainring-service.server/select-nearest-date definition exists."
...
(deftest test-log-process-drawing-info-existence
  ...
  (testing "if the chainring-service.server/log-process-drawing-info definition exists."
