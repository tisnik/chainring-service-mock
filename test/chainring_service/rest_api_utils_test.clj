...
(deftest test-read-request-body-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/read-request-body definition exists."
...
(deftest test-body->results-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/body->results definition exists."
...
(deftest test-send-response-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-response definition exists."
...
(deftest test-send-response-with-cookie-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-response-with-cookie definition exists."
    (is (callable?
          'chainring-service.rest-api-utils/send-response-with-cookie))))
...
(deftest test-send-ok-response-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-ok-response definition exists."
...
(deftest test-send-error-response-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-error-response definition exists."
...
(deftest test-send-error-response-wrong-date-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-error-response-wrong-date definition exists."
    (is (callable?
          'chainring-service.rest-api-utils/send-error-response-wrong-date))))
...
(deftest test-send-plain-response-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/send-plain-response definition exists."
...
(deftest test-get-timestamp-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/get-timestamp definition exists."
...
(deftest test-current-time-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/current-time definition exists."
...
(deftest test-valid-date?-existence
  ...
  (testing
    "if the chainring-service.rest-api-utils/valid-date? definition exists."
